...
//Traits can be used as parameters for a function and can be used to constrain generic types.
trait Authentication{
    fn auth(&self) -> String;
}
// a function that accepts any type that implements the Authentication trait, written as impl followed by the trait bound.
