...
//The result Type has a lot og methods which helps to handle and propagate errors. Result.expect, Result.unwrap, Result.Ok, Result.err, Result.unwrap_or(). This various me
fn using_Result(){
    let 
