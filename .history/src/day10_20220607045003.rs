...
fn main(){
    let boolean = NewGeneric{x:ttrue, y:False}; //Implicitly specified type parameter. 
...
fn using_generics<T>(s:MultiGeneric<Y,U>){ // This is a generic function that takes an argument s of type MultiGeneric<Y,U>
