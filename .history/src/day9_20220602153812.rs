...
//Collection is a data structuthat can contain multiple values, the major difference between collections , array and tuple types, collections point are stored on the heap.
