...
//It is a collection of methods that is defined for a type, which represents the behavior of its implementor. The implementor behavior tells us what methods 
...
trait Area{
    fn area(&self) -> f64; // Example of trait definiton. 
}
