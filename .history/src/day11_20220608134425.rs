...
//Using Trait on a type. To implement a trait for a type the keyword "impl trait for Type" where traits is the name of the trait been implemented and Type is the name of the 
pub struct Circle{
    rad: f64,
} 
pub struct Triangle{
