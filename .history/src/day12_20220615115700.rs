...
fn main(){
    using_panic("blue");
    using_panic("red"); //thread 'main' panicked at 'I dont like this colour', src/main.rs:12:10note: run with `RUST_BACKTRACE=1` environment variable to display a backtrace
}
